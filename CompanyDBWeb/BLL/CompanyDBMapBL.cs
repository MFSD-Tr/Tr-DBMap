...
namespace BLL
{
    public class CompanyDBMapBL
    {
        ...
        public List<CompanyDTO> GetCompanyList()
        {
            ...
            try
            {
                List<Company> list = uow.CompanyRepo.GetAll().Where(a=>a.Active==true).ToList();
        ...
        /// <param name="CompanyDBId"></param>
        /// <returns></returns>
        public Boolean DeleteCompanyDBInfo(CompanyDBDTO CompanyDBDTOobject)
        {
            bool flag = false;
            try
            {
                ...
                companydbObj.FkCompanyId = companydbObj.FkCompanyId;
